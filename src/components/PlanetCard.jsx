...
const PlanetCard = ({ planet }) => {
  return (
    <div className="rounded-lg shadow-lg shadow-slate-100 border transform transition duration-300 hover:scale-105 text-white bg-opacity-50 backdrop-filter backdrop-blur-sm p-6 bg-slate-500">
